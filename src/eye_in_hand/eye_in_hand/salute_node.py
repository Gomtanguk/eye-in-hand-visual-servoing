...
from eye_in_hand.speak import speak

# 로컬 STT(Whisper) 사용: eye_in_hand/STT.py 의 STT 클래스를 import
try:
    from eye_in_hand.stt import STT
except Exception:
    STT = None
    ...
    def __init__(self):
        ...
        if self.use_local_stt and STT is None:
            self.get_logger().warn(
                "use_local_stt=True 이지만 eye_in_hand.STT import 실패. "
                "패키지 경로/파일명(eye_in_hand/STT.py) 확인하세요. "
