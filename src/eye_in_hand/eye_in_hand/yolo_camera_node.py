...
def _resolve_model_path(model: str, package_name: str = "eye_in_hand") -> Tuple[str, List[str]]:
    tried: List[str] = []
...
class YoloCameraNode(Node):
    def __init__(self):
        ...
        # -------------------------------
        resolved, tried = _resolve_model_path(self._model_path_raw, package_name="eye_in_hand")
